  ...
  return (
    <>
      ...
      {launch!.links!.flickr_images && imagesLength > 0 && (
        <StyledImage
          source={{ uri: launch!.links!.flickr_images[0] as string }}
        />
      )}
      <DetailsContainer>
        {launch?.details && (
        ...
        {articleLink && (
          <Pressable
            onPress={() =>
              Linking.openURL(launch?.links?.article_link as string)
            }
          >
            <Row>
        ...
        {preskitLink && (
          <Pressable
            onPress={() => Linking.openURL(launch?.links?.presskit as string)}
          >
            <Row>
              <StyledIcon name="link" color={"#f5f5f5"} />
        ...
        {wikipedia && (
          <Pressable
            onPress={() => Linking.openURL(launch?.links?.wikipedia as string)}
          >
            <Row>
              <StyledIcon name="link" color={"#f5f5f5"} />
